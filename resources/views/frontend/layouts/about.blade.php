<div class="banner-area" id="banner" style="background: #bb3a2b;">
        <!-- banner area start -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="thumb after-left-top">
                            <img src="{{ asset('storage/sliders/banner_slider_logo.jpg') }}" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6 align-self-center">
                        <div class="banner-details mt-4 mt-lg-0">
                            <!-- <div class="post-meta-single">
                                <ul>
                                    <li><a class="tag-base tag-red" href="#">ACTI INDIA</a></li>
                                    <li class="date"><i class="fa fa-clock-o"></i>08.22.2020</li>
                                </ul>
                            </div> -->
                            
                            <h2>Best Professional IT Trainning Institute</h2>
                            <p>We provides professional information technology trainning in order to prepare qualified individuals for permanent and contract employment with Systegration, Inc.,  an affiliated consulting and professional firm.</p>
                            <a class="btn btn-blue" href="{{ route('front.aboutus') }}">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
