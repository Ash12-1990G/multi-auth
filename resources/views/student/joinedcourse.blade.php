              ...
              <div class="card pt-2 h-100">
                ...
                <div class="card-body pt-0">
                      ...
                      <div class="btn-group">
                        ...
                        <a class="btn btn-sm btn-outline-secondary text-dark mr-1" href="{{ route('student.courseview',['course'=>$item->course_id,'tab'=>'syllabus']) }}"><i class="far fa-list-alt"></i> Syllabus</a>
                        
                        <a class="btn btn-sm btn-outline-secondary bg-warning text-dark" href="{{ route('student.courseview',['course'=>$item->course_id,'tab'=>'review']) }}"><i class="far fa-star "></i>Review</a>
                      </div>
                      
                     
                    <div class="text-right pt-3">
                    
                    <a href="{{ route('student.courseview',['course'=>$item->course_id,'tab'=>'review']) }}" class="btn btn-block btn-sm btn-primary">
                      View
                    </a>
                  </div>
                </div>
