        ...
        <div class="main" style="margin-bottom:50px;height:100%;">
          <div class="icard" >
            ...
            <div style="flex: 1 1 auto;padding:0;">
              <div id="id-main"><img src="{{public_path('assets/img/icard/icard.jpg')}}"></div>
              <div class="icard-user-img">
                <img src="{{ public_path('storage/students/'.$data->image) }}" alt="User profile picture" class="icard-img">
              </div>
              ...
              <div id="icard-footer"><img src="{{public_path('assets/img/icard/icard-footer.jpg')}}"></div>
            </div>
          </div>  
        </div>
    </div>
