...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{$details->students->users->name}}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><a href="{{ route('student.payment.index',['courseid'=>$details->id]) }}"> Payment</a></li>
...
<div class="content">
    <div class="container-fluid">
        ...
        <h4><b>Course: </b><span class="text-danger">{{$details->courses->name}} ({{$details->courses->course_code}})</span></h4>
    <form class="form-normal g-3" action="{{route('student.payment.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
        <div class="row ">
            <div class="col-lg-12">
                    ...
                    <div class="card-header card-header-custom">
                        ...
                        <div class="card-body row ">
                            <div class="form-group col-lg-6 col-sm-12">
                                ...
                                <input type="hidden" name="course_student_id" value="{{ $details->id }}">
