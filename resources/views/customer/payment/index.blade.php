        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('customer.studentcourses.index',['student_id'=>$details->student_id]) }}"> Course</a></li>
        ...
        <div class="row">
          <div class="col-lg-4">
           <div class="card card-primary card-outline">
              ...
              @php 
              $installment = number_format( (float)$details->price/6,2);
              $due = $details->due;
              @endphp
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Total Amount</b> <a class="float-right"><i class="fas fa-rupee-sign"></i> {{$details->price}}</a>
                  </li>
                  <li class="list-group-item">
                  ...
                  @php
                  $installmnt_dates[1]=$details->start_date;
                    for($i=2;$i<=5;$i++){
                      $installmnt_dates[$i]= Carbon\Carbon::parse($details->students->admission)->addMonths($i)->format('Y-m-d');
                    }
          ...
          <div class="card">
              <div class="card-header">
                <h5 class="card-title">{{$details->students->users->name}} (<b>Course: </b><span class="text-danger">{{$details->courses->name}} ({{$details->courses->course_code}})</span>)</h5>
                
                <div class="card-tools">
                
                <a class="btn btn-primary btn-sm"  href="{{ route('student.payment.create',$details->id) }}">Add Payment</a>
...
<script type="text/javascript">
  ...
  $.ajaxSetup({
        ...
        var table = $('#user-datatable').DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax:'{!! route('student.payment.index',$details->id) !!}',
