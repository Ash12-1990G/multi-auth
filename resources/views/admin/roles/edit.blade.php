        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    @endif
                    {!! Form::model($role, ['route' => ['roles.update', $role->id],'method' => 'PATCH','class' => 'form-normal']) !!}
                        <div class="card-body">
                                                ...
                                                @foreach($permissionlist as $permission)
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if(isset($permission['create']))
                                                            ...
                                                            {{ Form::checkbox('permission[]',$permission['create'], in_array($permission['create'], $rolePermissions) ? true : false, array('id'=>'check'.$permission['create'],'class' => 'name form-check-input permission')) }}
                                                                <label class="form-check-label" for="check{{$permission['create']}}">Add</label>
                                                            </div>
                                                        @endif
                                                        @if(isset($permission['edit']))
                                                            <div class="icheck-primary my-0 mr-3">
                                                            {{ Form::checkbox('permission[]', $permission['edit'], in_array($permission['edit'], $rolePermissions) ? true : false, array('id'=>'check'.$permission['edit'],'class' => 'name form-check-input permission')) }}
                                                                <label class="form-check-label" for="check{{$permission['edit']}}">Edit</label>
                                                            </div>
                                                        @endif
                                                        @if(isset($permission['delete']))
                                                            <div class="icheck-primary my-0 mr-3">
                                                            {{ Form::checkbox('permission[]', $permission['delete'], in_array($permission['delete'], $rolePermissions) ? true : false, array('id'=>'check'.$permission['delete'],'class' => 'name form-check-input permission')) }}
                                                                <label class="form-check-label" for="check{{$permission['delete']}}">Delete</label>
                                                            </div>
                                                        @endif
                                                        @if(isset($permission['list']))
                                                            <div class="icheck-primary my-0 mr-3">
                                                            {{ Form::checkbox('permission[]', $permission['list'], in_array($permission['list'], $rolePermissions) ? true : false, array('id'=>'check'.$permission['list'],'class' => 'name form-check-input permission')) }}
                                                                <label class="form-check-label" for="check{{$permission['list']}}">List</label>
                                                            </div>
                                                        @endif
                                                        @if(isset($permission['show']))
                                                            <div class="icheck-primary my-0 mr-3">
                                                            {{ Form::checkbox('permission[]', $permission['show'], in_array($permission['show'], $rolePermissions) ? true : false, array('id'=>'check'.$permission['show'],'class' => 'name form-check-input permission')) }}
