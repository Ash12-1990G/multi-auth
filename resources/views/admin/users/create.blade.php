                    ...
                    @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group mb-3">
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="{{ __('Email Address') }}"  autocomplete="email">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                <!-- {!! Form::select('roles[]', $roles,[], array('class' => 'select2','data-placeholder' => 'Select Role','multiple')) !!} -->
