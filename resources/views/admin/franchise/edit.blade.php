...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Edit Franchise</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                    ...
                    @method('PATCH')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="first-upper form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name',$franchise->name)}}">
                                    @if ($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="subname" class="first-upper form-control {{ $errors->has('subname') ? ' is-invalid' : '' }}" placeholder="" value="{{ old('subname',$franchise->subname)}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="cost" class="form-control {{ $errors->has('cost') ? ' is-invalid' : '' }}"  value="{{ old('cost',$franchise->cost)}}">
                                    @if ($errors->has('cost'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="details" id="detail" class="form-control {{ $errors->has('details') ? ' is-invalid' : '' }}">{{ old('details',$franchise->details)}}</textarea>
