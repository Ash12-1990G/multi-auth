        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><a href="{{route('customers.index')}}">Customers</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('customer_franchise.index',['customer'=>$customer]) }}"> Franchise</a></li>
...
<div class="content">
    ...
    <form class="form-normal g-3" action={{route('customer_franchise.store')}} method="post" enctype="multipart/form-data">
                    @csrf
        <div class="row">
            <div class="col-lg-6">
                    ...
                    <div class="card-header card-header-custom">
                        ...
                        <div class="card-body row ">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="number" name="amount" id="price" class="form-control {{ $errors->has('amount') ? ' is-invalid' : '' }}"  value="{{old('amount')}}" min="1">
                            ...
                            <div class="form-group col-12">
                                ...
                                <select class="payment-select form-control {{ $errors->has('payment_option') ? ' is-invalid' : '' }}" name="payment_option" required>
                                    ...
                                    <option value="full" {{ old('payment_option')=='installment' ? 'selected':'' }}>Full</option>
                                </select>
                    ...
                    <div class="card-body row">
                        <div class="form-group col-6">
                            ...
                            <label  class="form-label">Service Taken</label>
                                <input type="text" name="service_taken" id="datepicker" class="form-control {{ $errors->has('service_taken') ? ' is-invalid' : '' }}"  value="{{old('service_taken')}}" autocomplete="off">
                        ...
                        <div class="form-group col-6">
                            ...
                            <label  class="form-label">Service Ends</label>
                                <input type="text" name="service_ends" id="datepicker2" class="form-control {{ $errors->has('service_ends') ? ' is-invalid' : '' }}"  value="{{old('service_ends')}}" autocomplete="off">
...
$('.custom-select').on('select2:select', function (e) { 
    ...
    $.ajax({
        type: 'GET',
        url: '{!! route('customer_franchise.selected',['customer'=>$customer]) !!}',
        data: data,
        dataType: 'json',
        beforeSend: function(){
            // things to do before
...
$('.payment-select').select2({
  ...
  $('.custom-select').select2({
    ...
    ajax: {
            url: '{!! route('customer_franchise.searchfranchise',['customer'=>$customer]) !!}',
            dataType: 'json',
            delay: 250,
