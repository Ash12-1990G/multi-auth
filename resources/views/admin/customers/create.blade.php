                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body row ">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="input" name="cust_name" class="form-control {{ $errors->has('cust_name') ? ' is-invalid' : '' }}"  value="{{old('cust_name')}}" placeholder="Required">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body row ">
                        <div class="form-group col-12">
                                ...
                                <textarea name="address"  class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}" placeholder="Required">{{old('address')}}</textarea>
                            ...
                            <div class="form-group col-3">
                                ...
                                <input type="text" name="state"  class="first-upper form-control {{ $errors->has('state') ? ' is-invalid' : '' }}"  value="{{old('state')}}" placeholder="Required">
                                @if ($errors->has('state'))
                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group col-3">
                                ...
                                <input type="text" name="pincode"  class="form-control {{ $errors->has('pincode') ? ' is-invalid' : '' }}"  value="{{old('pincode')}}" placeholder="Required">
            ...
            <div class="col-lg-6">
                <div class="card card-danger">
                    ...
                    <div class="card-body row ">
                        ...
                        <div class="form-group col-12">
                                <label  class="form-label">Start-up Location <button type="button"class="btn btn-outline-primary btn-sm" onclick="getCordinates(event);"  id="check-btn-loc">Check the distance </button></label>
                                <input type="hidden" name="latitude" id="latitude"value="">
                                <input type="hidden" name="longitude" id="longitude"value="">
                                <textarea name="location" id="location" rows="3"   class="form-control location {{ $errors->has('location') ? ' is-invalid' : '' }}" placeholder="Required">{{old('location')}}</textarea>
